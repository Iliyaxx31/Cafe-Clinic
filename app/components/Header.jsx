...
const Header = ({ logo, coffeName }) => {
  ...
  return (
    <div className="w-[95hw] overflow-hidden object-cover flex-col h-40 items-center flex justify-center gap-4  bg-gradient-to-l from-[#fdf6e7] via-[#d1eefc] to-blue-200/80">
      <Image
