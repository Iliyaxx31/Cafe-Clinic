        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <div>
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-white font-semibold lg:text-[14px] text-[12px] tracking-wide">Cafe Clinic</span>
            </div>
            <p className="text-cyan-400/50 text-[8px] lg:text-[10px] ml-1 tracking-widest uppercase">Coffee & Drinks</p>
          </div>
        </div>
